...
data.plot <- pivot_longer(data.plot, c("AA_freq", "AG_freq", "GG_freq"), values_to = "frequency", names_to = "genotype")

rs2476601.plot <- ggplot(data=data.plot, aes(x=region, y=frequency, fill=genotype)) +
...
rs3087243.plot <- ggplot(data=data.plot, aes(x=region, y=frequency, fill=genotype)) +
  geom_bar(stat="identity", width=0.7)+
  scale_fill_discrete(labels=c("AA", "AG", "GG"))+
  xlab("data origin")+
  theme_minimal()
...
data.plot <- pivot_longer(data.plot, c("GG_freq", "GT_freq", "TT_freq"), values_to = "frequency", names_to = "genotype")

rs3807306.plot <- ggplot(data=data.plot, aes(x=region, y=frequency, fill=genotype)) +
  geom_bar(stat="identity", width=0.7)+
...
rs1800629.plot <- ggplot(data=data.plot, aes(x=region, y=frequency, fill=genotype)) +
  geom_bar(stat="identity", width=0.7)+
  scale_fill_discrete(labels=c("AA", "AG", "GG"))+
  xlab("data origin")+
  theme_minimal()
...
data.plot <- pivot_longer(data.plot, c("CC_freq", "CT_freq", "TT_freq"), values_to = "frequency", names_to = "genotype")

rs1799724.plot <- ggplot(data=data.plot, aes(x=region, y=frequency, fill=genotype)) +
  geom_bar(stat="identity", width=0.7)+
