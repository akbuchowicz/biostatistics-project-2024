...
data.rs2476601 <- data.frame(region, A_freq, G_freq, AA_freq, AG_freq, GG_freq)
print(data.rs2476601)
```
## rs3087243
...
data.rs3087243 <- data.frame(region, A_freq, G_freq, AA_freq, AG_freq, GG_freq)
print(data.rs3087243)
```
...
data.rs3807306 <- data.frame(region, G_freq, T_freq, GG_freq, GT_freq, TT_freq)
print(data.rs3807306)
```
...
data.rs1800629 <- data.frame(region, G_freq, T_freq)
print(data.rs1800629)
```
...
data.rs1799724 <- data.frame(region, C_freq, T_freq, CC_freq, CT_freq, TT_freq)
print(data.rs1799724)
```